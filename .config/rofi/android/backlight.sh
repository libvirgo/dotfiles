...
case $chosen in
    $ICON_UP)
        light -A 10 && notify-send -u low -t 1500 "Brightness Up $ICON_UP"
        ;;
    $ICON_DOWN)
        light -U 10 && notify-send -u low -t 1500 "Brightness Down $ICON_DOWN"
        ;;
    $ICON_OPT)
        light -S 35 && notify-send -u low -t 1500 "Optimal Brightness $ICON_OPT"
        ;;
esac
